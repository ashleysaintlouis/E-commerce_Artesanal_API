...
var sequelize = require('../config/sequelize'); // Assumindo seu arquivo de configuração do Sequelize
...
var User = sequelize.define('User', {
  ...
  password: {
    // É uma boa prática usar 'password' em inglês
    type: DataTypes.STRING,
    allowNull: false
  ...
  tableName: 'user',
  // Define explicitamente o nome da tabela (opcional, o padrão é o nome do modelo no plural)
